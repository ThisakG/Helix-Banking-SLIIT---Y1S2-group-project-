...
<body>
    ...
    <main>
        <section class="manage-loan-fd">
            <h2>Manage Loan Scheme</h2>
        </section>

        <section>

             <!--creating a form to enter data to add new Loan Schemes to the database-->
            <form action="submitAddLoanSchemePage.php" method="POST">

            <label for="field1">Loan Scheme No: </label>
            ...
            <label for="field3">Loan Amount: </label>
            <input type="text" name="field3">
            <br><br>

            <label for="field4">Installement Rates: </label>
